export interface Country {
  name: string; // Kurdish Sorani display name (pure text, no emoji)
  nameEn: string; // English name for search
  flag: string; // Flag emoji (fallback)
  code: string; // ISO 3166-1 alpha-2 (or KRD for Kurdistan)
}

export const COUNTRIES: Country[] = [
  // Kurdistan first
  { name: "کوردستان", nameEn: "Kurdistan", flag: "☀️", code: "KRD" },
  ...
  // Africa
  { name: "میسر", nameEn: "Egypt", flag: "🇪🇬", code: "EG" },
