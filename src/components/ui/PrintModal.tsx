...
function buildTemplateHTML(
  ...
  for (const b of t.blocks.filter(b => b.visible)) {
    ...
    else if (b.id === "bonus") { const totalBonusQty = order.items.reduce((s, i) => s + i.bonusQty, 0); if (totalBonusQty > 0) parts.push(`<div class="inv-bonus-info"><div style="font-size:11px;font-weight:700;color:#7C5CFC;margin-bottom:4px">شیکاری بۆنەس</div><div style="font-size:12px;color:#6C757D">کۆی دانەی بۆنەس: ${totalBonusQty} دانە</div></div>`); }
