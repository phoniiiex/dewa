...
import {
  ...
  Edit3, Save, X, Phone, Mail, User, Activity, Stethoscope, Map,
} from "lucide-react";
  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "پزیشکەکان",      href: "/dashboard/doctors",    icon: <Stethoscope size={18} /> },
        { label: "نەخشەی زیندوو",   href: "/dashboard/map",        icon: <Map size={18} /> },
